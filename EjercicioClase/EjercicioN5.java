...
public class EjercicioN5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------");
        System.out.println("El/La mÃ¡s viejo es: " + getMasViejo(listaPersonas));
        System.out.println("El/La mÃ¡s joven es: " + getMasJoven(listaPersonas));
        System.out.println("El/La que mÃ¡s gana es: " + getMenorSueldo(listaPersonas));
    ...
    static Persona getMasViejo(List<Persona> listaPersonas) {
        if (listaPersonas.size() != 0) {
            ...
            System.out.println("Archivo vacÃ­o.!!");
        }
        return null;
    }
